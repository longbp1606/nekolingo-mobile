...
const StatsBar: React.FC = () => {
  ...
  const statsData: StatItemData[] = [
    ...
    },
    {
      ...
      modal: {
        ...
        content:
          "Keep up your learning streak! Complete lessons daily to maintain it.",
        type: "streak",
    ...
    },
    {
      ...
      modal: {
        title: "Total XP",
        content: `You have earned ${user?.xp || 0} XP in total!`,
      ...
      <View style={styles.modalContent}>
        ...
        <View style={styles.modalHeader}>
          ...
          <Text style={styles.modalSubtitle}>
            <FontAwesome6 name="bolt-lightning" size={14} color="#FFD700" /> 4G
            54PH
          </Text>
        </View>
  ...
  const renderStreakModal = () => {
    const [activeTab, setActiveTab] = useState<"personal" | "friends">(
      "personal"
    );
    const currentMonth = getCurrentMonthData();
                ...
                <View style={styles.calendarHeader}>
                  ...
                  <View style={styles.navigationButtons}>
                    <TouchableOpacity
                      style={[
                        styles.navButton,
                        currentMonthIndex === 0 && styles.navButtonDisabled,
                      ]}
                  ...
                  <View style={styles.statItemStreak}>
                    <View style={styles.statIconBlue}>
                      <Text style={styles.statNumberWhite}>
                        {getStreakFreezeUsed(currentMonth)}
                      </Text>
                    </View>
                    <Text style={styles.statLabel}>
                      Số streak freeze đã dùng
                    </Text>
                  </View>
                </View>
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <View style={styles.modalOverlay}>{renderCoursesModal()}</View>
      </Modal>
      ...
      <Modal
        ...
        onRequestClose={closeModal}
      >
        <View style={styles.modalOverlay}>{renderHeartsModal()}</View>
      </Modal>
      ...
      <Modal
        ...
        onRequestClose={closeModal}
      >
        <View style={styles.modalOverlayStreak}>{renderStreakModal()}</View>
      </Modal>
    </View>
  );
};
